        ...
        <Box>
          <Flex flexWrap="wrap" justifyContent="space-around">
            {products3.map(product3=>{
              return <Link to={`/product3/${product3.id}`}key={product3.id}><ProductSimple  image={product3.image} title={product3.title} price={product3.price} oprice={product3.oprice}/></Link>
            })}
          </Flex>
        </Box>
        </Stack>
